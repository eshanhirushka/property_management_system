  ...
  return (
    <Box>
      ...
      <Box mt="20px" display="flex" flexWrap="wrap" gap={4}>
        ...
        <PieChart title="Total Cities" value={555} series={[75, 25]} colors={['#275be8', '#c4e8ef']} />
      </Box>
      ...
      <Box flex={1} borderRadius="15px" padding="20px" bgcolor="#fcfcfc" display="flex" flexDirection="column" minWidth="100%" mt="25px">
        <Typography fontSize={14} fontWeight={600} color="#11142d">Latest Properties</Typography>
